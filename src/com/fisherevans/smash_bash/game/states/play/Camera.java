...
public class Camera {
    ...
    public void calculateTargetPosition() {
        ...
        float xZoom = SmashBash.container.getWidth()/(bottomRight.getX()-topLeft.getX()+DEFAULT_CAMERA_PADDING);
        float yZoom = SmashBash.container.getHeight()/(topLeft.getY()-bottomRight.getY()+DEFAULT_CAMERA_PADDING);

...
import com.fisherevans.smash_bash.game.states.play.object_controllers.CharacterController;
...
public class GameCharacter extends GameObject {
    ...
    public GameCharacter(PlayState playState, String name, int spriteId, Rectangle body, CharacterDefinition definition) {
        ...
        _lives = SmashBash.gameSettings.lives;
        _maxHealth = (int)(SmashBash.gameSettings.health*_definition.healthScale);
        _health = _maxHealth;

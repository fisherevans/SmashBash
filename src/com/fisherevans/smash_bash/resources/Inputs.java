...
import com.fisherevans.smash_bash.input.*;
...
public class Inputs {
    ...
    public static void load() {
        ...
        SmashBash.container.getInput().addKeyListener(keyboardListener);
    }
    ...
    public static void inputEvent(Key key, boolean state, int sourceId) {
        if(SmashBash.game.getCurrentState() instanceof InputsListener) {
            InputsListener listener = (InputsListener) SmashBash.game.getCurrentState();
            if(state)
